...
<div style="background: #f8f9fa; min-height: calc(100vh - 80px); padding: 2rem;">
    <div style="max-width: 1400px; margin: 3rem auto; margin: 3rem  25rem;">
        ...
        <!-- Search Form -->
        <form method="GET" action="<?php echo e(route('students.index')); ?>" style="margin-bottom: 2rem;">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/vahatra/Downloads/etudiant_app_laravel/resources/views/students/index.blade.php ENDPATH**/ ?>