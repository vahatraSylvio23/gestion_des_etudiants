...
<div style="display: flex; justify-content: center; align-items: center; min-height: 80vh;">
    <div class="card" style="max-width: 400px; width: 100%;">
        <div style="text-align: center; margin-bottom: 2rem;">
            ...
            <p style="color: #999; font-size: 0.85rem;">Test: admin / admin123</p>
        </div>
        ...
        <form method="POST" action="<?php echo e(route('login')); ?>">
            ...
            <div class="form-group">
                <label class="form-label">
                    <i class="fas fa-user"></i> <?php echo e(__('messages.username')); ?>

                </label>
                <input type="text" name="username" class="form-control" value="<?php echo e(old('username')); ?>" required autofocus>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/vahatra/Downloads/etudiantappfonctionnelphp/etudiant_app_laravel/resources/views/auth/login.blade.php ENDPATH**/ ?>